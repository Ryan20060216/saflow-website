...
const translations = {
    zh: {
        ...
        'services.2.title': '歐盟包材合規',
        'services.2.desc': '提供歐盟 PPWR 法規包裝解決方案，確保產品順利進入歐洲市場',
        ...
        'contact.address': '台中市太平區旱溪西路二段176號',
    ...
    en: {
        ...
        'services.2.title': 'EU Packaging Compliance',
        'services.2.desc': 'Provide PPWR packaging solutions for EU market access',
        ...
        'contact.tag': 'Contact',
        'contact.title': 'Contact Method',
        'contact.subtitle': 'Feel free to contact us anytime',
        'contact.address.title': 'Our Address',
        'contact.address': 'No. 176, Sec. 2, Hanxi West Rd., Taiping Dist., Taichung City',
